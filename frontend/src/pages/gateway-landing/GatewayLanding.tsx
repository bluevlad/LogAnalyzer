...
const CONNECTED_SERVICES: Connected[] = [
  { name: 'AllergyInsight', role: '로그 수집 대상', href: 'https://allergyinsight.unmong.com', dot: '#f43f5e' },
  { name: 'SkillRadar', role: '로그 수집 대상', href: 'https://skillradar.unmong.com', dot: '#8b5cf6' },
